...
import ch.wesr.data.random.datagenerator.types.TypeHandler;
import ch.wesr.data.random.datagenerator.types.TypeHandlerFactory;
...
public class RandomJsonGenerator {
    ...
    private static final Logger log = LoggerFactory.getLogger(RandomJsonGenerator.class);
